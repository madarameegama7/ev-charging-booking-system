      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-12">
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-600 mb-6 leading-relaxed">
              EV Charge specializes in providing comprehensive electric vehicle
              charging solutions for operators and businesses. We deliver
              scalable infrastructure, smart management systems, and reliable
              support to power the future of sustainable transportation.
            </p>
            <div className="flex gap-3">
              <a
                href="#"
                className="w-10 h-10 bg-[#347928] rounded-full flex items-center justify-center text-white transition-colors duration-200"
              >
                <Instagram size={20} />
              </a>
              <a
        ...
        <div className="pt-8 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-600 text-sm text-center md:text-left">
            Copyright © 2025 EVCharge Technologies (Pvt) Ltd. All Rights
            Reserved.
          </p>
